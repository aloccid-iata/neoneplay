                    ...
                    <div className="flex">
                        {cardData && cardData.headers['revision'] == cardData.headers['latest-revision'] &&
                            <>
                                ...
                                {!inEdit && getTypeString(cardData.headers['type']) == "Waybill" &&
                                    <button
                                        id="BDI-Button"
                                        onClick={() => { }}
                                        className={` flex-initial  top-0 border-slate-400 rounded-lg border-[1px] mr-1`}>
                                        <svg id="BDI-Icon" className='fill-slate-800 m-2 left-[-1px] top-[-1px]' height="16"  width="16" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                            <path id="BDI-Path1" d="M149.967 737.683c89.939 112.963 218.1 183.595 360.342 183.595s270.403-70.631 360.342-183.595c-114.372-38.862-235.277-59.718-360.342-59.718s-245.969 20.855-360.342 59.718z" />
                                            <path id="BDI-Path3" d="M957.482 388.196v0c-114.756-15.534-224.733-62.739-320.9-137.742l-83.519-65.139c-22.692-21.726-55.35-21.515-77.836 0.502l-92.863 70.937c-95.109 72.652-203.6 117.753-316.517 131.579v0c-25.268 6.999-39.386 38.604-29.894 66.925l39.781 70.492c23.613 41.84 40.783 88.208 50.731 136.997l2.893 14.189 104.341-35.466c66.847-22.721 135.618-37.027 205.105-41.695 47.897-3.217 95.908-3.3 143.813-0.252 68.465 4.357 136.281 17.876 202.316 39.504l115.743 37.908c8.050-58.009 26.182-113.46 53.271-162.918l33.342-60.874c8.256-27.707-5.531-57.746-29.807-64.948zM597.38 439.119c0 31.954-15.714 61.866-42.026 79.997l-24.917 17.171c-12.037 8.294-27.924 8.381-40.050 0.218l-23.899-16.090c-26.817-18.053-42.896-48.263-42.896-80.591v-64.148h173.79v63.443z" />
                                        </svg>
                                    </button>
                                }
                                <button
